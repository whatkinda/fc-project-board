...
class ArticleControllerTest {
    ...
    @WithMockUser   // user 정보 mocking해서 넣어줌
    ...
    @WithUserDetails(value="jhTest",userDetailsServiceBeanName = "userDetailsService", setupBefore = TestExecutionEvent.TEST_EXECUTION)    // 실제 지정한 UserDetails를 사용하게끔. (실제 db에 있어야 하는 user)
