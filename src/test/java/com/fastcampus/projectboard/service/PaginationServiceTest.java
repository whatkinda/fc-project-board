...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.NONE, classes = PaginationService.class)    // springboot test 무게 줄이기
class PaginationServiceTest {
    ...
    // 스펙의 명세를 코드에 드러내기 위해 테스트 작성
    @DisplayName("현재 설정돼 있는 페이지네이션 바의 길이를 알려준다.")
    @Test
    void givenNothing_whenCalling_thenReturnsCurrentBarLength() {
        //given

        //when
        int barLength = sut.currentBarLenth();
